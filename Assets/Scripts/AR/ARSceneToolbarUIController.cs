...
namespace AR {
    ...
    public class ARSceneToolbarUIController : MonoBehaviour {
        ...
        private void Start() {
            VisualElement root = toolbarManager.RootElement;
            ...
            toolbarManager.AddButtonAction(ToolbarButton.AR, ToggleSettingsMenu);

            toolbarManager.SetButtonVisibility(ToolbarButtonGroups.BottomRow, false);
            toolbarManager.SetButtonVisibility(ToolbarButton.MainMenu, true);
            toolbarManager.SetButtonVisibility(ToolbarButton.AR, true);
            toolbarManager.SetButtonVisibility(ToolbarButton.Back, false);
