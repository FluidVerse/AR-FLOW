...
namespace MainMenu {
    ...
    public class MainMenuManager : MonoBehaviour {
        ...
        private Slider OptionsMenu_SliderSensitivity; // touch sensitivity
        ...
        /// <summary>
        /// Returns whether the continue button in the main menu should be active or not.
        /// </summary>
        ...
        private void Awake() {
            ...
            OptionsMenu_SliderSensitivity.RegisterValueChangedCallback(_ =>
            ...
            SceneManager.sceneLoaded += (scene, _) => OnSceneLoaded(scene.name);
        }
        ...
        private void OnSceneLoaded(string sceneName) {
            if (sceneName == mainMenuSceneName) {
                return; // main menu doesn't have a toolbar, all good
            }
            toolbarManager = FindAnyObjectByType<ToolbarManager>();
            if (toolbarManager == null) {
                Debug.LogError("New scene loaded, but no ToolbarManager found in the scene.", this);
                return;
            }
            //toolbarManager.onMainMenuButtonClick.AddListener(OnMainMenuButtonClick);
            toolbarManager.AddButtonAction(ToolbarButton.MainMenu, OnMainMenuButtonClick);
            Debug.Log("New scene loaded, ToolbarManager found and linked.", this);
        }

        /// <summary>
        /// Callback for <see cref="ToolbarButton.MainMenu"/>.
        /// </summary>
        ...
        private void MainMenu_ClickButtonContinue() {
            if (!CanContinue) {
        ...
        private void ClickButtonBackToMainMenu() {
            OptionsMenu.style.display = DisplayStyle.None;
            LevelMenu.style.display = DisplayStyle.None;
            MainMenu.style.display = DisplayStyle.Flex;
        }

        private void MainMenu_ClickButtonOption() {
            MainMenu.style.display = DisplayStyle.None;
            LevelMenu.style.display = DisplayStyle.None;
        ...
        private void MainMenu_ClickButtonLevel() {
            MainMenu.style.display = DisplayStyle.None;
            OptionsMenu.style.display = DisplayStyle.None;
            LevelMenu.style.display = DisplayStyle.Flex;
        }

        private void MainMenu_ClickButtonQuit() {
            //GlobalSettings.Instance.LoadGame();
            Application.Quit();
        }

        private void OptionsMenu_ChangeSliderSensitivity() {
            Debug.Log(OptionsMenu_SliderSensitivity.value);
