...
### 1.1
- **UI Code Rewrite**: Partial rewrite of the UI code for improved ease of use and better code maintainability.
- **New Tutorial Level**: Added a new interactive tutorial level to help new developers get familiar with the application.
- **Developer Documentation**: Added tutorial PDFs (German and English) for developers interested in creating new custom levels.

### 1.0
- Initial release of AR FLOW
...
These tutorial PDFs explain how to create new levels in AR FLOW. They are intended for developers/contributors, not for players.

- German: [DE-ar-flow-tutorial.pdf](Docs/DE-ar-flow-tutorial.pdf)
- English: [EN-ar-flow-tutorial.pdf](Docs/EN-ar-flow-tutorial.pdf)
